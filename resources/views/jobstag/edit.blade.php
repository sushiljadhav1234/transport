...
@if(Auth::user()->user_type == 'Admin')
				...
				<div class="main-container">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<form method="post" action ="{{route('jobstag.update')}}" id="myform" autocomplete="off">
                        @csrf
						<div class="row gutters">
							...
							<div class="col-md-4">
								<div class="form-group">
                                   ...
                                   <input type="hidden" class="form-control" value="{{$data->id}}"  name="id" placeholder="Tag Name">
									<input type="text" class="form-control" value="{{$data->tagname}}" id="tagname" name="tagname" placeholder="Tag Name">
